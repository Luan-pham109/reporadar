...
## 2bis. Hiến pháp biên tập: bộ lọc IN/OUT + 4 lăng kính ngành
...
| `trustScore` | (Phase 2) sao thật/giả | Hoãn |
...
4. **Vertical-fit:** mỗi record có trả lời được đúng câu lăng kính ngành (cắt khâu nào / tiết kiệm gì) *có bằng chứng* không? Tự test, mục tiêu ≥80% record đạt.

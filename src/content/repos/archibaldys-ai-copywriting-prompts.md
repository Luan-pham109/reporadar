...
repoStats:
  ...
  openIssues: 0
standoutFeatures:
  - "Tên và topic hướng tới prompt copywriting/marketing automation cho ChatGPT, Claude."
  - "README chủ yếu là advertorial cho tool 'Slito EX', kết bằng một call-to-action và link rút gọn (jmp9.com) — dấu hiệu funnel tiếp thị, không phải thư viện prompt thực."
  - "Chỉ 1 fork, 0 issue, không có commit sau ngày tạo — mức độ dự án rất mỏng."
signalSources:
  - label: "GitHub"
...
vnMarket:
  insight: "Người Việt tìm 'prompt viết content AI' rất nhiều, nên tiêu đề repo dễ hút click. Tuy nhiên README thực chất là advertorial cho công cụ trả phí Slito EX với link tiếp thị rút gọn, không phải kho prompt mở. Đưa lên feed sẽ có rủi ro dẫn người đọc vào funnel bán hàng thay vì cho họ giá trị thật."
  seoKeywords: ["prompt viết content ai", "prompt copywriting chatgpt", "prompt viết caption facebook", "ai viết bài social media"]
  notes: "Dựa trên README + số liệu GitHub. Dấu hiệu funnel tiếp thị (link jmp9.com, giọng bài PR) khá rõ. Độ chắc chắn: trung bình."
...
aiCheck:
  canAIGetThis: false
  note: "AI dễ bị tiêu đề đánh lừa là 'kho prompt'. Việc bóc ra rằng đây là advertorial trá hình và không nên khuyến nghị cần con người đọc kỹ và có kỷ luật IN/OUT."
